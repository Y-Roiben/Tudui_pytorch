...
if __name__ == "__main__":
    f, axs = plt.subplots(4, N_HIDDEN + 1, figsize=(12, 6))
    ...
    plt.figure(3)
    plt.plot(test_x.data.numpy(), preds[0].data.numpy(), c='#FF9359', lw=4,)
    plt.plot(test_x.data.numpy(), preds[1].data.numpy(), c='#74BCFF', lw=4)
    plt.scatter(test_x.data.numpy(), test_y.data.numpy(), c='r', s=50, alpha=0.2)
    plt.show()
